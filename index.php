...
// Variable para almacenar el mensaje de la operación
$message = "";
...
<!-- Mostrar el mensaje de la operación si existe -->
<script>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">RESTAURANTE<a href="http://localhost/hotel/restau/REST_CRUD/PROGRAMACION/MEN%C3%9A/index22.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
